...
{
    const char* pszTimestamp = "KGA Blockchain Class 4th Start At 18/Oct/2021";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1617604141, 1214009, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xde0bc9e62461efb7cb25b3dfadef8e3b9d032872b04d99bf121793691774161d"));
        assert(genesis.hashMerkleRoot == uint256S("0x17fc12152daf402bd67a3bbee1895f997537b38d0dc3d6478d07d0f665b30c33"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,45);  //우리는 kigacoin이니까 k로 바꾸자 기존 48이었음
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1645587173, 2572211, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x13f611d597e568ed379a03bd7d8b3f7b3be0677875c5abf7c02d3e903963cf6f"));
        assert(genesis.hashMerkleRoot == uint256S("0x17fc12152daf402bd67a3bbee1895f997537b38d0dc3d6478d07d0f665b30c33"));
